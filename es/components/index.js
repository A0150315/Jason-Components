...
var css =
  ".index-module_mask__3ZnGd{position:fixed;top:0;bottom:0;right:0;left:0;height:100%;background-color:rgba(0,0,0,.5);transition:opacity .2s;will-change:opacity}.index-module_audio__2rEax{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) scale(0);transition:transform .2s;will-change:transform}.index-module_audio_show__3CRcb{transform:translate(-50%,-50%) scale(1)}";
var styles = {
  mask: "index-module_mask__3ZnGd",
  audio: "index-module_audio__2rEax",
  audio_show: "index-module_audio_show__3CRcb"
};
styleInject(css);
...
var Audio = memo(function Audio(props) {
  ...
  return React.createElement(
    "button",
    { type: "button", className: className, onClick: handler },
    children
  );
});
